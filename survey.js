...
<div class="question">
  ...
  <label>
    ...
    <strong>３点：作業と健康や幸福の関係性を理解し、概ね理解し、多くのクライエントに共通する一般的な説明ができる</strong>
  </label><br>
  <label>
...
<div class="question">
  ...
  <label>
    ...
    <strong>２点：クライエントにとって意味のある作業を一部把握するが、十分に深堀りせず見落としや確認不足がある</strong>
  </label><br>
  <label>
